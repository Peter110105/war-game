...
│   │     │  │
│   │     │  └─ unit/
│   │     │     ├─ unit-types.config.ts     # 單位類型定義
│   │     │     ├─ unit-stats.config.ts     # 單位屬性配置
│   │     │     ├─ exp.config.ts            # 經驗值配置
│   │     │     └─ index.ts                 # 統一導出
│   │     │
│   │     ├─ factory/               
